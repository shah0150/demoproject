var app = {
    ...
    saveProfile: function () {
        ...
        if (document.getElementById('txtSex') != null) {
        ...
        if (document.getElementById('txtTimeOfDay') != null) {
        ...
        app.db.transaction(function (tx) {
                ...
                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['clothing', clothing], function () {}, function (e) {
                    console.log(e.message);
                });

                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['time', time], function () {}, function (e) {
                    console.log(e.message);
                });

                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['social', social], function () {}, function (e) {
                    console.log(e.message);
                });

                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['transport', transport], function () {}, function (e) {
                    console.log(e.message);
                });

                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['number', number], function () {}, function (e) {
                    console.log(e.message);
                });

                tx.executeSql('insert into profile(item_name, item_value) values(?,?)', ['facial', facial], function () {}, function (e) {
                    console.log(e.message);
                });
